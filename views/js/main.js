...
var resizePizzas = function(size) {
  ...
  // Looks at the switch postion and returns a value
  // that can be used to be applied to 
  // .randomPizzaContainer's style. Consider moving to
  // bootstrap grid to take advantage of breakpoints
  ...
  // size switcher evaluates the the switch position
...
function updatePositions() {
  ...
  requestAnimationFrame(pizzaMath);
